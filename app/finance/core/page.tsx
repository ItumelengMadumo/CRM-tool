...
export default function CoreFinanceDocuments() {
  ...
  const financeDocs = [
    ...
    { title: "Statements", href: "/finance/core/Statements" },
    { title: "Delivery Notes", href: "/finance/DeliveryNotes" },
    { title: "Pro Forma Invoices", href: "/finance/pro-forma-invoices" },
  ]
  const CoreFinanceDocuments = [
    {
      type: "Invoice",
      number: "INV-2023-001",
      client: "Acme Inc",
